...
Correct examples for this exact style of board (note the SPLIT cells at 2,2 and 6,3 producing TWO lines each, the img=true picture clues, and hyphenated cell text kept verbatim):
...
CLUE row=8 col=4 dir=down img=true clue="moon and stars"
